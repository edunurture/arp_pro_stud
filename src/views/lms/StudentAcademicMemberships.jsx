...
const StudentAcademicMemberships = () => {
  ...
  // ✅ HTML-equivalent cancel behavior
  const handleCancel = () => {
    ...
    <>
      ...
      <CCard className="mb-3">
        <CCardHeader className="d-flex justify-content-between align-items-center">
          <strong>Student Memberships</strong>
      ...
      <CCard className="mb-3">
        <CCardHeader>
          <strong>ADD STUDENT MEMBERSHIP DETAILS</strong>
        </CCardHeader>
        ...
        <CCardBody>
          <CRow className="mb-3">
            <CCol md={6}>
              ...
              <CRow className="mb-2">
                <CCol md={5}>Scope of Membership</CCol>
                <CCol md={7}>
            ...
            <CCol md={6}>
              <CRow className="mb-2">
                <CCol md={5}>Name of Organization</CCol>
                <CCol md={7}>
                  <CFormInput size="sm" disabled={!isAddNew} />
                </CCol>
              </CRow>
              ...
              <CRow className="mb-2">
                <CCol md={5}>Organization URL</CCol>
                <CCol md={7}>
                  <CFormInput size="sm" disabled={!isAddNew} />
                </CCol>
              </CRow>
...
export default StudentAcademicMemberships
