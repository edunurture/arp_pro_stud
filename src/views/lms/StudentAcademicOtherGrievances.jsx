...
const StudentAcademicOtherGrievances = () => {
  const student = {
    ...
    <>
      <CCard className="mb-3">
        <CCardHeader className="d-flex justify-content-between align-items-center">
          <strong>Student Other Grievances</strong>
      ...
      <CCard>
        <CCardHeader><strong>APPLY OTHER GRIEVANCES</strong></CCardHeader>
        <CCardBody>
...
export default StudentAcademicOtherGrievances
