...
const StudentAcademicMOOCs = () => {
  ...
  return (
    <>
      ...
      <CCard className="mb-3">
        <CCardHeader>
          <strong>ADD CERTIFICATION COURSE DETAILS (MOOC)</strong>
        </CCardHeader>
        <CCardBody>
          <CRow className="mb-3">
            <CCol md={6}>
...
export default StudentAcademicMOOCs
