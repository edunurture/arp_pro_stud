...
const StudentAcademicAwardsMedals = () => {
    ...
    <>
      ...
      <CCard className="mb-3">
        <CCardHeader className="d-flex justify-content-between align-items-center">
          <strong>Student Awards / Medals</strong>
      ...
      <CCard className="mb-3">
        <CCardHeader>
          <strong>ADD AWARDS AND MEDALS DETAILS</strong>
        </CCardHeader>
        ...
        <CCardBody>
          <CRow className="mb-3">
            <CCol md={6}>
              ...
              <CRow className="mb-2">
                <CCol md={5}>Place of Award / Medal</CCol>
                <CCol md={7}>
            ...
            <CCol md={6}>
              ...
              <CRow className="mb-2">
                <CCol md={5}>Name of Award / Medal</CCol>
                <CCol md={7}>
                  <CFormInput size="sm" disabled={!isAddNew} />
                </CCol>
              </CRow>
...
export default StudentAcademicAwardsMedals
