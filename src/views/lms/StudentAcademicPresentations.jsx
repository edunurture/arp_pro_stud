...
const StudentAcademicPresentations = () => {
    ...
    <>
      ...
      <CCard className="mb-3">
        <CCardHeader className="d-flex justify-content-between align-items-center">
          <strong>Student Paper Presentation</strong>
      ...
      <CCard className="mb-3">
        <CCardHeader>
          <strong>ADD PAPER PRESENTATION DETAILS</strong>
        </CCardHeader>
        ...
        <CCardBody>
          <CRow className="mb-3">
            <CCol md={6}>
              ...
              <CRow className="mb-2">
                <CCol md={5}>Presentation Award (if any)</CCol>
                <CCol md={7}>
...
export default StudentAcademicPresentations
