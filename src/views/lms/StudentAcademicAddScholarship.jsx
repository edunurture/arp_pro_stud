// StudentAcademicAddScholarship.jsx
...
const StudentAcademicAddScholarship = () => {
  const student = {
    ...
    <>
      ...
      <CCard className="mb-3">
        <CCardHeader className="d-flex justify-content-between align-items-center">
          <strong>Student Add Scholarship</strong>
      ...
      <CCard className="mb-3">
        <CCardHeader>
          <strong>ADD SCHOLARSHIP DETAILS</strong>
        </CCardHeader>
        ...
        <CCardBody>
          <CRow className="mb-3">
            <CCol md={6}>
              ...
              <CRow className="mb-2">
                <CCol md={5}>Scheme of Scholarship</CCol>
                <CCol md={7}><CFormInput size="sm" /></CCol>
              </CRow>

              <CRow className="mb-2">
                <CCol md={5}>Term of Scholarship</CCol>
                <CCol md={7}><CFormInput size="sm" /></CCol>
              </CRow>
            </CCol>
            ...
            <CCol md={6}>
              <CRow className="mb-2">
                <CCol md={5}>Type of Scholarship</CCol>
                <CCol md={7}>
                  <CFormSelect size="sm">
                    <option>Select</option>
              ...
              <CRow className="mb-2">
                <CCol md={5}>Sanctioned Amount</CCol>
                <CCol md={7}><CFormInput size="sm" /></CCol>
              </CRow>

              <CRow className="mb-2">
                <CCol md={5}>Remarks</CCol>
                <CCol md={7}><CFormInput size="sm" /></CCol>
              </CRow>
            </CCol>
          </CRow>
...
export default StudentAcademicAddScholarship
