...
const StudentAcademicCompetitiveExaminations = () => {
    ...
    <>
      ...
      <CCard className="mb-3">
        <CCardHeader className="d-flex justify-content-between align-items-center">
          <strong>Student Competitive Exams</strong>
      ...
      {/* Competitive Examination Form */}
      <CCard className="mb-3">
        <CCardHeader>
          <strong>ADD COMPETITIVE EXAMINATION DETAILS</strong>
        </CCardHeader>
        ...
        <CCardBody>
          <CRow className="mb-3">
            <CCol md={6}>
              ...
              <CRow className="mb-2">
                <CCol md={5}>Level of Examination</CCol>
                <CCol md={7}>
                  <CFormSelect size="sm" disabled={!isAddNew}>
              ...
              <CRow className="mb-2">
                <CCol md={5}>Date of Examination</CCol>
                <CCol md={7}>
            ...
            <CCol md={6}>
              <CRow className="mb-2">
                <CCol md={5}>Type of Examination</CCol>
                <CCol md={7}>
                  <CFormInput size="sm" disabled={!isAddNew} />
                </CCol>
              </CRow>
              ...
              <CRow className="mb-2">
                <CCol md={5}>Name of Examination</CCol>
                <CCol md={7}>
                  <CFormInput size="sm" disabled={!isAddNew} />
                </CCol>
              </CRow>
              ...
              <CRow className="mb-2">
                <CCol md={5}>Qualified?</CCol>
                <CCol md={7}>
                  <CFormSelect size="sm" disabled={!isAddNew}>
                    <option>QUALIFIED / NOT QUALIFIED</option>
                  </CFormSelect>
                </CCol>
              </CRow>

              <CRow className="mb-2">
                <CCol md={5}>Agency</CCol>
                <CCol md={7}>
                  <CFormInput size="sm" disabled={!isAddNew} />
                </CCol>
              </CRow>
...
export default StudentAcademicCompetitiveExaminations
