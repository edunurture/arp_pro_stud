...
// StudentAcademicSeminarConferences.jsx
...
const StudentAcademicSeminarConferences = () => {
  const student = {
    ...
    <>
      ...
      <CCard className="mb-3">
        <CCardHeader className="d-flex justify-content-between align-items-center">
          <strong>Student Seminar / Conference</strong>
      ...
      <CCard className="mb-3">
        <CCardHeader>
          <strong>PARTICIPATION OF SEMINAR / CONFERENCES</strong>
        </CCardHeader>
        <CCardBody>
          <CRow className="mb-3">
            <CCol md={6}>
...
export default StudentAcademicSeminarConferences
