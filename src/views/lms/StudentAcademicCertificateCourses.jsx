...
// StudentAcademicCertificateCourses.jsx
...
const StudentAcademicCertificateCourses = () => {
  const student = {
    ...
    <>
      <CCard className="mb-3">
        <CCardHeader className="d-flex justify-content-between align-items-center">
          <strong>Student Certificate Courses</strong>
      ...
      <CCard className="mb-3">
        <CCardHeader>
          <strong>ADD CERTIFICATION COURSE DETAILS – CERTIFICATE COURSES</strong>
        </CCardHeader>
        <CCardBody>
          <CRow className="mb-3">
            <CCol md={6}>
...
export default StudentAcademicCertificateCourses
