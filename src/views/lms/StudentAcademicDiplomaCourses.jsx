...
// StudentAcademicDiplomaCourses.jsx
...
const StudentAcademicDiplomaCourses = () => {
  const student = {
    ...
    <>
      <CCard className="mb-3">
        <CCardHeader className="d-flex justify-content-between align-items-center">
          <strong>Student Diploma Courses</strong>
      ...
      <CCard className="mb-3">
        <CCardHeader>
          <strong>ADD CERTIFICATION COURSE DETAILS – DIPLOMA COURSES</strong>
        </CCardHeader>
        <CCardBody>
          <CRow className="mb-3">
            <CCol md={6}>
...
export default StudentAcademicDiplomaCourses
