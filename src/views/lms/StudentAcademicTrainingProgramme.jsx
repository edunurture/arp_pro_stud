...
// StudentAcademicTrainingProgramme.jsx
...
const StudentAcademicTrainingProgramme = () => {
    ...
    <>
      ...
      <CCard className="mb-3">
        <CCardHeader className="d-flex justify-content-between align-items-center">
          <strong>Student Training Programme</strong>
      ...
      <CCard className="mb-3">
        <CCardHeader>
          <strong>ADD TRAINING PROGRAMME DETAILS</strong>
        </CCardHeader>
        <CCardBody>
          ...
          <CRow className="mb-3">
            <CCol md={6}>
              ...
              <CRow className="mb-2">
                <CCol md={5}>Title of Training</CCol>
                <CCol md={7}><CFormInput size="sm" /></CCol>
              </CRow>
            </CCol>
            ...
            <CCol md={6}>
              ...
              <CRow className="mb-2">
                <CCol md={5}>Training Duration</CCol>
...
export default StudentAcademicTrainingProgramme
