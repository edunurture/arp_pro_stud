...
// StudentAcademicSportsActivities.jsx
...
const StudentAcademicSportsActivities = () => {
  const student = {
    ...
    <>
      ...
      <CCard className="mb-3">
        <CCardHeader className="d-flex justify-content-between align-items-center">
          <strong>Student Sports Activities</strong>
      ...
      <CCard className="mb-3">
        <CCardHeader>
          <strong>ADD EXTRA CURRICULAR DETAILS – SPORTS ACTIVITIES</strong>
        </CCardHeader>
        <CCardBody>
          <CRow className="mb-3">
            ...
            <CCol md={3}>Name of the Sports</CCol>
...
export default StudentAcademicSportsActivities
